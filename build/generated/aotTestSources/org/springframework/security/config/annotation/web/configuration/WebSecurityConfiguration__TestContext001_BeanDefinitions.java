...
import org.springframework.web.filter.ServletRequestPathFilter__TestContext001_BeanDefinitions;
...
public class WebSecurityConfiguration__TestContext001_BeanDefinitions {
  ...
  /**
   * Get the bean instance supplier for '(inner bean)#73dd3a46'.
   */
  ...
  public static class CompositeFilterChainProxy {
    /**
     * Get the bean instance supplier for '(inner bean)#63053b71'.
     */
    ...
    public static BeanDefinition getSpringSecurityFilterChainInnerBeanBeanDefinition() {
      ...
      beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, ManagedList.of(ServletRequestPathFilter__TestContext001_BeanDefinitions.getSpringSecurityFilterChainInnerBeanBeanDefinition(), WebSecurityConfiguration__TestContext001_BeanDefinitions.getSpringSecurityFilterChainInnerBeanBeanDefinition()));
      beanDefinition.setInstanceSupplier(getSpringSecurityFilterChainInnerBeanInstanceSupplier());
      return beanDefinition;
    }
  }
