...
public class AutoConfigurationPackages__TestContext001_BeanDefinitions {
  ...
  public static class BasePackages {
    ...
    public static BeanDefinition getAutoConfigurationPackagesBeanDefinition() {
      ...
      beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, new String[] {"com.example.crmchatbotbackend", "org.springframework.modulith.events.jpa.updating"});
