 ...
 */
@Generated
public class SchedulingConfiguration__TestContext001_BeanDefinitions {
  /**
  ...
  private static BeanInstanceSupplier<ScheduledAnnotationBeanPostProcessor> getInternalScheduledAnnotationProcessorInstanceSupplier(
    ...
    return BeanInstanceSupplier.<ScheduledAnnotationBeanPostProcessor>forFactoryMethod(SchedulingConfiguration.class, "scheduledAnnotationProcessor")
            .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.scheduling.annotation.SchedulingConfiguration", SchedulingConfiguration.class).scheduledAnnotationProcessor());
  }
  ...
  public static BeanDefinition getInternalScheduledAnnotationProcessorBeanDefinition() {
    ...
    beanDefinition.setRole(BeanDefinition.ROLE_INFRASTRUCTURE);
    beanDefinition.setFactoryBeanName("org.springframework.scheduling.annotation.SchedulingConfiguration");
