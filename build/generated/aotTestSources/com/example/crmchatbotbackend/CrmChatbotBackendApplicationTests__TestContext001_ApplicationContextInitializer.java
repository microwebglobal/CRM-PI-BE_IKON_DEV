 ...
 */
@Generated
public class CrmChatbotBackendApplicationTests__TestContext001_ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new CrmChatbotBackendApplicationTests__TestContext001_BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new CrmChatbotBackendApplicationTests__TestContext001_BeanFactoryRegistrations().registerAliases(beanFactory);
  }
  ...
  private void addImportAwareBeanPostProcessors(DefaultListableBeanFactory beanFactory) {
    ...
    mappings.put("org.springframework.security.config.annotation.method.configuration.PrePostMethodSecurityConfiguration", "com.example.crmchatbotbackend.config.SecurityConfig");
    ...
    mappings.put("org.springframework.scheduling.annotation.ProxyAsyncConfiguration", "org.springframework.modulith.events.config.EventPublicationAutoConfiguration$AsyncEnablingConfiguration");
