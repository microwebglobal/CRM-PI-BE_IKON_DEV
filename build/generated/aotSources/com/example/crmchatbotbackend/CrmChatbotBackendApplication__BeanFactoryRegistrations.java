...
import com.vaadin.flow.spring.SpringSecurityAutoConfiguration__BeanDefinitions;
...
public class CrmChatbotBackendApplication__BeanFactoryRegistrations {
  ...
  public void registerBeanDefinitions(DefaultListableBeanFactory beanFactory) {
    ...
    beanFactory.registerBeanDefinition("com.vaadin.flow.spring.SpringSecurityAutoConfiguration", SpringSecurityAutoConfiguration__BeanDefinitions.getSpringSecurityAutoConfigurationBeanDefinition());
    beanFactory.registerBeanDefinition("vaadinDefaultRequestCache", SpringSecurityAutoConfiguration__BeanDefinitions.getVaadinDefaultRequestCacheBeanDefinition());
    beanFactory.registerBeanDefinition("navigationAccessControlInitializer", SpringSecurityAutoConfiguration__BeanDefinitions.getNavigationAccessControlInitializerBeanDefinition());
    beanFactory.registerBeanDefinition("navigationAccessControl", SpringSecurityAutoConfiguration__BeanDefinitions.getNavigationAccessControlBeanDefinition());
    beanFactory.registerBeanDefinition("navigationAccessControlConfigurerCustomizer", SpringSecurityAutoConfiguration__BeanDefinitions.getNavigationAccessControlConfigurerCustomizerBeanDefinition());
    beanFactory.registerBeanDefinition("annotatedViewAccessChecker", SpringSecurityAutoConfiguration__BeanDefinitions.getAnnotatedViewAccessCheckerBeanDefinition());
    beanFactory.registerBeanDefinition("routePathAccessChecker", SpringSecurityAutoConfiguration__BeanDefinitions.getRoutePathAccessCheckerBeanDefinition());
    beanFactory.registerBeanDefinition("accessPatchChecker", SpringSecurityAutoConfiguration__BeanDefinitions.getAccessPatchCheckerBeanDefinition());
    beanFactory.registerBeanDefinition("accessAnnotationChecker", SpringSecurityAutoConfiguration__BeanDefinitions.getAccessAnnotationCheckerBeanDefinition());
    beanFactory.registerBeanDefinition("requestUtil", SpringSecurityAutoConfiguration__BeanDefinitions.getRequestUtilBeanDefinition());
    beanFactory.registerBeanDefinition("vaadinRolePrefixHolder", SpringSecurityAutoConfiguration__BeanDefinitions.getVaadinRolePrefixHolderBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("org.springframework.boot.autoconfigure.http.client.reactive.ClientHttpConnectorAutoConfiguration$ReactorNetty", ClientHttpConnectorAutoConfiguration__BeanDefinitions.ReactorNetty.getReactorNettyBeanDefinition());
